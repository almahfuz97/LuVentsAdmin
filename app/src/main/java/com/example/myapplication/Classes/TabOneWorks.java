...
public class TabOneWorks {
    ...
    String mEventName,mAddress,mDescription;
   ...
   public void dateEndPicker()
    ...
    public void createEvent(Uri mUri,String extension) {
        ...
        if (mUri == null) {
            ...
            storageTask = fileRef.putFile(mUri)
    ...
    private void storeInDatabase(String mName,String mAdd,String mDesc)
    {
        ...
        mAddress=mAdd;
        mDescription=mDesc;
        CreateModel createModel=new CreateModel(mEventName,mAddress,mDescription,imageUri,"gfgj",mYear,mMonth+1,mDate,mEndYear2,mEndMonth2+1,mEndDate2,mHour,mMin,mEndHour,mEndMin,System.currentTimeMillis());
        FirebaseFirestore.getInstance().collection("Events").add(createModel).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
            ...
            public void onComplete(@NonNull Task<DocumentReference> task) {
                ...
                CreateModel createModel2=new CreateModel(mEventName,mAddress,mDescription,imageUri,task.getResult().getId(),mYear,mMonth+1,mDate,mEndYear2,mEndMonth2+1,mEndDate2,mHour,mMin,mEndHour,mEndMin,System.currentTimeMillis());
